...
summon item_display ~ ~1 ~ {Tags:["baseshare.base_beacon_name", "baseshare.custom_block"], CustomName: '{"text": "Please place a sign on me to name me!"}', CustomNameVisible: true}