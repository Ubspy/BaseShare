...
execute store result score @s TmpVal run data get storage baseshare:bases Players[-1].PlayerIndex
...
execute unless score @s TmpVal = @s BaseSharePlayers run function baseshare:orderarray